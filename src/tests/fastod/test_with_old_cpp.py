...
def configure_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument('-f', '--first', type=str, required=True, help='Path to the C++ algorithm implementation')
    parser.add_argument('-s', '--second', type=str, required=True, help='Path to the old C++ algorithm implementation')
...
if __name__ == '__main__':
    ...
    test_c_vs_old_c(args.first, args.second, args.comparer, args.datasets)