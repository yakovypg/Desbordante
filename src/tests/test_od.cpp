...
INSTANTIATE_TEST_SUITE_P(TestFastODSuite, TestFastOD,
    ::testing::Values(
            DatasetWithHashAndFolder{"CLASSIFICATION_norm.csv", 18091212580651051245ULL, "metanome"},
            ...
            DatasetWithHashAndFolder{"breast-cancer-wisconsin.csv", 16353518380015578090ULL, "metanome"},
            DatasetWithHashAndFolder{"echocardiogram_norm.csv", 326215408910846314ULL, "metanome"},
            DatasetWithHashAndFolder{"hepatitis_norm.csv", 7742226892016166457ULL, "metanome"},
            DatasetWithHashAndFolder{"hepatitis_norm_1.csv", 17523839062965376704ULL, "metanome"},
            DatasetWithHashAndFolder{"hepatitis_norm_2.csv", 6299823600881027889ULL, "metanome"},
            DatasetWithHashAndFolder{"hepatitis_norm_3.csv", 14366259447601078560ULL, "metanome"},
            DatasetWithHashAndFolder{"hepatitis_norm_4.csv", 17523839062965376704ULL, "metanome"},
            DatasetWithHashAndFolder{"hepatitis_norm_5.csv", 10213031677476394156ULL, "metanome"},
