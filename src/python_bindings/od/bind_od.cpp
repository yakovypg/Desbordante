...
void BindOd(py::module_& main_module) {
    ...
    py::class_<AscCanonicalOD>(od_module, "AscCanonicalOD")
            ...
            .def("__hash__", [](AscCanonicalOD const& od) { return py::hash(od.ToString()); });
    ...
    py::class_<DescCanonicalOD>(od_module, "DescCanonicalOD")
            ...
            .def("__hash__", [](DescCanonicalOD const& od) { return py::hash(od.ToString()); });
    ...
    py::class_<SimpleCanonicalOD>(od_module, "SimpleCanonicalOD")
            ...
            .def("__hash__", [](SimpleCanonicalOD const& od) { return py::hash(od.ToString()); });
